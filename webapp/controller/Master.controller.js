...
sap.ui.define([
	...
	return BaseController.extend("itsgrp.com.br.OrdemSemiAcabado.controller.Master", {
		...
		_onMasterMatched: function() {
			this.getOwnerComponent().oListSelector.oWhenListLoadingIsDone.then(
				function(mParams) {
					...
					var sObjectId1 = mParams.firstListitem.getBindingContext().getProperty("posnr");
		...
		_showDetail: function(oItem) {
			...
			this.getRouter().navTo("object", {
				...
				objectId1: oItem.getBindingContext().getProperty("posnr")
			}, bReplace);
		},
