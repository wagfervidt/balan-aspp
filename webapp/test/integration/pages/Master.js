						...
						success : function (aEntityData) {
							this.waitFor({
								...
								success : function (oList) {
									...
									oCurrentItem.bindingPath = "/" + oList.getModel().createKey("ZC_ORDENS", {
										aufnr : sCurrentId
									});
			...
			assertions : {
				...
				theListHeaderDisplaysZeroHits : function () {
					return this.waitFor({
						viewName : sViewName,
						id : "page",
						matchers : new PropertyStrictEquals({name : "title", value : "<ZC_ORDENS> (0)"}),
						success : function () {
				...
				theListShouldHaveAllEntries : function () {
					...
					// retrieve all ZC_ORDENS to be able to check for the total amount
					...
					return this.waitFor({
						...
						success : function (oList) {
							...
							this.waitFor({
								id : "page",
								viewName : sViewName,
								matchers : new PropertyStrictEquals({name : "title", value : "<ZC_ORDENS> (" + iExpectedLength + ")"}),
								success : function () {
