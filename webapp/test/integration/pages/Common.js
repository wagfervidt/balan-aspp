sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("itsgrp/com/br/OrdemSemiAcabado/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("itsgrp.com.br.OrdemSemiAcabado.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["itsgrp/com/br/OrdemSemiAcabado/localService/mockserver"], function (mockserver) {
